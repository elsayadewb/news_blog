                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" style="height:150px" name="description" placeholder="Detail">{{ $comment->description }}</textarea>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-select form-control" name ="post_id" aria-label="Default select example"  >
                                    <option selected value="{{ $comment->post_id }}">{{ $comment->title }}</option>
